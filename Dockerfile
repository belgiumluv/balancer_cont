...
# Можно зафиксироваться на версии:
...
# НИКАКИХ вызовов 'lego' здесь! Только распаковка бинарника.
...
# ----- Скрипты и конфиги -----
COPY scripts /scripts        # тут generate_domain.py и т.п.
COPY configs /configs        # prometheus.yml
